...
class KeyboardController:
    def __init__(self):
        ...
        print('This node takes keypresses from the keyboard and simulates publishing Twist messages.')
        print('It works best with a US keyboard layout.')
        print('---------------------------')
        print('Moving around:')
        print('   u    i    o')
        print('   j    k    l')
    ...
    def publish_velocity(self):
        ...
        if (abs(self.current_linear_x) > 0.0 or abs(self.current_angular_z) > 0.0):
            ...
            print(f'Publishing velocity: linear_x={linear_x:.2f}, angular_z={angular_z:.2f}')
            # 重置零速度发布标志
            self.zero_velocity_published = False
